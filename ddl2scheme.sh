...
#
CREATE_ORDER_TYPES="_TABLESPACES_,USERS,TYPES,OBJECT_GRANTS,TABLES,SEQUENCES,DB_LINKS,VIEWS,SYNONYMS,FUNCTIONS,PROCEDURES,PACKAGES,JAVA_SOURCES,DATA_TABLES,CONSTRAINTS,_RECOMPILE_,OBJECT_GRANTS,_RECOMPILE_,OBJECT_GRANTS,_RECOMPILE_,INDEXES,REF_CONSTRAINTS,TRIGGERS,JOBS,DBMS_JOBS,REFRESH_GROUPS"
